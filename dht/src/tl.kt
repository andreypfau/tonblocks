...
import tl.ton.*
import tl.ton.Dht
import tl.ton.DhtKey
import tl.ton.DhtUpdateRule

typealias TlDhtKey = DhtKey
typealias TlDhtKeyDescription = tl.ton.DhtKeyDescription
typealias TlDhtNode = tl.ton.DhtNode
typealias TlDhtUpdateRule = DhtUpdateRule
typealias TlDht = Dht
typealias TlDhtFindNode = DhtFindNode
typealias TlDhtNodes = DhtNodes
typealias TlDhtFindValue = DhtFindValue
typealias TlDhtValueResult = DhtValueResult
typealias TlDhtStore = DhtStore
typealias TlDhtValue = tl.ton.DhtValue
...
class DhtTlClient(
    ...
    override suspend fun store(value: tl.ton.DhtValue): DhtStored {
        val buffer = Buffer()
